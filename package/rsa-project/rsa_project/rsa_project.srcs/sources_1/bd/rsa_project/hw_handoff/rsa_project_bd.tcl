...
proc create_root_design { parentCell } {
  ...
  # Create instance: Montgomery_Interface_0, and set properties
  set Montgomery_Interface_0 [ create_bd_cell -type ip -vlnv user.org:user:Montgomery_Interface:1.0 Montgomery_Interface_0 ]
  set_property -dict [ list \
CONFIG.NUM_OF_CORES {1} \
 ] $Montgomery_Interface_0
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: montgomery_wrapper_0, and set properties
  set block_name montgomery_wrapper
  set block_cell_name montgomery_wrapper_0
  if { [catch {set montgomery_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $montgomery_wrapper_0 eq "" } {
...
CONFIG.NUM_SI {1} \
  ...
  connect_bd_intf_net -intf_net axis_to_bram_0_bram [get_bd_intf_pins Montgomery_Interface_0/bram] [get_bd_intf_pins axis_to_bram_0/bram]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins Montgomery_Interface_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins Montgomery_Interface_0/S01_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net Montgomery_Interface_0_leds [get_bd_ports leds] [get_bd_pins montgomery_wrapper_0/leds]
  connect_bd_net -net Montgomery_Interface_0_mw_bram_din1 [get_bd_pins Montgomery_Interface_0/mw_bram_din1] [get_bd_pins montgomery_wrapper_0/bram_din1]
  connect_bd_net -net Montgomery_Interface_0_mw_bram_din2 [get_bd_pins Montgomery_Interface_0/mw_bram_din2] [get_bd_pins montgomery_wrapper_0/bram_din2]
  connect_bd_net -net Montgomery_Interface_0_mw_bram_din_valid [get_bd_pins Montgomery_Interface_0/mw_bram_din_valid] [get_bd_pins montgomery_wrapper_0/bram_din_valid]
  connect_bd_net -net Montgomery_Interface_0_mw_bram_dout_read [get_bd_pins Montgomery_Interface_0/mw_bram_dout_read] [get_bd_pins montgomery_wrapper_0/bram_dout_read]
  connect_bd_net -net Montgomery_Interface_0_mw_clk [get_bd_pins Montgomery_Interface_0/mw_clk] [get_bd_pins montgomery_wrapper_0/clk]
  connect_bd_net -net Montgomery_Interface_0_mw_port1_din [get_bd_pins Montgomery_Interface_0/mw_port1_din] [get_bd_pins montgomery_wrapper_0/port1_din]
  connect_bd_net -net Montgomery_Interface_0_mw_port1_valid [get_bd_pins Montgomery_Interface_0/mw_port1_valid] [get_bd_pins montgomery_wrapper_0/port1_valid]
  connect_bd_net -net Montgomery_Interface_0_mw_port2_read [get_bd_pins Montgomery_Interface_0/mw_port2_read] [get_bd_pins montgomery_wrapper_0/port2_read]
  connect_bd_net -net Montgomery_Interface_0_mw_resetn [get_bd_pins Montgomery_Interface_0/mw_resetn] [get_bd_pins montgomery_wrapper_0/resetn]
  connect_bd_net -net montgomery_wrapper_0_bram_dout1 [get_bd_pins Montgomery_Interface_0/mw_bram_dout1] [get_bd_pins montgomery_wrapper_0/bram_dout1]
  connect_bd_net -net montgomery_wrapper_0_bram_dout1_valid [get_bd_pins Montgomery_Interface_0/mw_bram_dout1_valid] [get_bd_pins montgomery_wrapper_0/bram_dout1_valid]
  connect_bd_net -net montgomery_wrapper_0_bram_dout2 [get_bd_pins Montgomery_Interface_0/mw_bram_dout2] [get_bd_pins montgomery_wrapper_0/bram_dout2]
  connect_bd_net -net montgomery_wrapper_0_bram_dout2_valid [get_bd_pins Montgomery_Interface_0/mw_bram_dout2_valid] [get_bd_pins montgomery_wrapper_0/bram_dout2_valid]
  connect_bd_net -net montgomery_wrapper_0_port1_read [get_bd_pins Montgomery_Interface_0/mw_port1_read] [get_bd_pins montgomery_wrapper_0/port1_read]
  connect_bd_net -net montgomery_wrapper_0_port2_valid [get_bd_pins Montgomery_Interface_0/mw_port2_valid] [get_bd_pins montgomery_wrapper_0/port2_valid]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Montgomery_Interface_0/s00_axi_aclk] [get_bd_pins Montgomery_Interface_0/s01_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axis_to_bram_0/s00_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Montgomery_Interface_0/S00_AXI/S00_AXI_reg] SEG_Montgomery_Interface_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Montgomery_Interface_0/S01_AXI/S01_AXI_reg] SEG_Montgomery_Interface_0_S01_AXI_reg
...
preplace port FIXED_IO -pg 1 -y 600 -defaultsOSRD
preplace portBus leds -pg 1 -y 460 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 3 -y 420 -defaultsOSRD
preplace inst Montgomery_Interface_0 -pg 1 -lvl 5 -y 240 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 680 -defaultsOSRD
preplace inst axis_to_bram_0 -pg 1 -lvl 4 -y 420 -defaultsOSRD
preplace inst montgomery_wrapper_0 -pg 1 -lvl 4 -y 130 -defaultsOSRD
...
preplace netloc axis_to_bram_0_bram 1 4 1 1650
preplace netloc Montgomery_Interface_0_mw_port1_valid 1 3 3 1160 290 NJ 50 2170
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 2 3 NJ 520 NJ 520 1660
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 400 820 NJ 820 NJ 820 NJ 820 2140
preplace netloc Montgomery_Interface_0_mw_port2_read 1 3 3 1120 490 NJ 490 2130
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 810 NJ 810 NJ 810 NJ 810 NJ 810 2130
preplace netloc montgomery_wrapper_0_port2_valid 1 4 1 1560
preplace netloc montgomery_wrapper_0_port1_read 1 4 1 1590
preplace netloc Montgomery_Interface_0_mw_clk 1 3 3 1080 310 NJ 30 2140
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 N
preplace netloc montgomery_wrapper_0_bram_dout2_valid 1 4 1 1610
preplace netloc montgomery_wrapper_0_bram_dout1_valid 1 4 1 1620
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 2 3 700 510 NJ 510 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 4 390 680 720 530 1080 350 1680
preplace netloc Montgomery_Interface_0_mw_port1_din 1 3 3 1110 320 NJ 40 2180
preplace netloc axi_dma_0_M_AXI_MM2S 1 3 1 1100
preplace netloc Montgomery_Interface_0_mw_resetn 1 3 3 1100 300 NJ 70 2130
preplace netloc Montgomery_Interface_0_mw_bram_dout_read 1 3 3 1140 280 NJ 60 2150
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc Montgomery_Interface_0_mw_bram_din_valid 1 3 3 1150 260 NJ 10 2190
preplace netloc Montgomery_Interface_0_leds 1 4 2 NJ 460 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 3 370 670 NJ 630 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 590 380 310 710 500 1110 500 1670 510 2130
preplace netloc montgomery_wrapper_0_bram_dout1 1 4 1 1580
preplace netloc axi_dma_0_M_AXIS_MM2S 1 3 1 1090
preplace netloc montgomery_wrapper_0_bram_dout2 1 4 1 1640
preplace netloc Montgomery_Interface_0_mw_bram_din1 1 3 3 1130 270 NJ 20 2160
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 700
preplace netloc Montgomery_Interface_0_mw_bram_din2 1 3 3 1090 330 NJ 410 2160
levelinfo -pg 1 0 200 550 910 1330 1910 2230 -top 0 -bot 830
",
}
