...
void add_mont_asm(uint32_t *t, uint32_t i, uint32_t C);
void sub_cond_mont_asm(uint32_t *t, uint32_t *n, uint32_t *p, uint32_t SIZE);
...
void mont_mult_asm(uint32_t *a, uint32_t *b, uint32_t *n, uint32_t *n0, uint32_t *res, uint32_t SIZE) {
	...
	sub_cond_mont_asm(t,n, res, SIZE);
}
...
void sub_cond_mont_asm(uint32_t *u, uint32_t *n, uint32_t *p, uint32_t SIZE){
	uint32_t B = 0;
	uint32_t t[MAX_SIZE];
	uint32_t sub = 0;
	uint32_t i;
