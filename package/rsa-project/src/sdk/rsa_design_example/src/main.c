...
#define MULT_TESTVECTOR 1
	...
	printMontExpResult(32);
	xil_printf("Expected: \r\n");
	printMontResult(expected_output, 32);
...
void test_hw_mont_exp() {
	...
	uint32_t exp_len =  8;
	uint32_t expected[16] = {0x73138981, 0x9dcee2dd, 0xcc05a3a9, 0x9d66ae39, 0x244186b5, 0xd0af1219, 0xcd7e4c08, 0x6d4cc1ce, 0x17a20e1b, 0x2bd8dde2, 0x099a7a3a, 0xc405fe12, 0x1f9b8f85, 0x5faed2c7, 0xf23948c3, 0xab96e8e6};
