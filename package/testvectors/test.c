...
int test_montgomery() {
    ...
    */
    ...
    /* Test RSA cipher reduction  (R = 2**640) */
    uint32_t a[20] = {0xc6ed5a07, 0xfd5268a3, 0x62a1a0e9, 0x00948219, 0xcb5deb52, 0x15bdb981, 0x42195370, 0xe89bda34, 0xc5543062, 0x50b4a48d, 0x49ed2dd9, 0x56883c9e, 0x075b51a1, 0xc9bc05b0, 0x94e7c179, 0x6145f145, 0xa635fe9b, 0x841a6546, 0x827535fc, 0x00000000};
    uint32_t b[20] = {0x3d051fc3, 0x1ff9ffd7, 0x2acef04e, 0x809ff24d, 0xb2a4d767, 0x1c0e8ced, 0xba0c8d86, 0x9aa30e72, 0x79a14472, 0xa06cbe86, 0x8bdc9053, 0xf0bc376c, 0x74d95a1e, 0xe67f8054, 0x5a66bd37, 0x88988875, 0x348577ff, 0x96090655, 0x31eb9e93, 0x00005193};
    uint32_t N[20] = {0x70299bed, 0x101794c6, 0xc0151c1c, 0x6e64da6d, 0x264cf9a0, 0x402b2671, 0xaa98562e, 0x65a57f24, 0x6bfda86a, 0xb60080d7, 0x63b6d666, 0x503b34b3, 0x096ebf14, 0xabfb0940, 0x1d4ef5c0, 0x7961d0cc, 0x9ae404fe, 0x353bd35b, 0x3b5b7bb9, 0x0000c144};
    /*uint32_t n_prime[1] = {0x0edf26bb};*/  /* = R_N - (1/N) % R_N , with R_N = R % N (does not work) */
    uint32_t n_prime[1] = {0xfd29061b};      /* = R - (1/N) % R (does work) */
    uint32_t expected_output[20] = {0x29ee38a8, 0x101c9c89, 0x778cadd2, 0xb9c93ac2, 0x3b6af774, 0x263cb2f1, 0xfff8e8c1, 0x72fa24e0, 0x6cf7e210, 0x735843bc, 0x9df9b52f, 0x8a9bfee5, 0xb3d7fd1a, 0x64466132, 0x6bec45e9, 0xb126e12d, 0x24deb8d6, 0xfc1a5138, 0xc0357d8f, 0x000041d7};
...
int test_exponentiation() {
    ...
    /* CRT-RSA signing part p seed = 2017 */
    #elif EXP_TESTVECTOR == 10
    uint32_t X[20] = {0xe9ebcbc7, 0x9bd3d96b, 0x5dc58597, 0x942d6e6d, 0x99e645b2, 0x42d0b2dc, 0xbefbbdc1, 0x1482a5cb, 0xb925235e, 0xfda26f19, 0xc2388174, 0x2becf65d, 0xfde03fb3, 0x8b60ba97, 0x832f7f59, 0xac1e4dd5, 0xb395f755, 0x5e3c242c, 0x8f388e79, 0x0000bb1d};
    uint32_t E[20] = {0x9b863c3d, 0xd2bfc787, 0x5c6835be, 0x8981895f, 0x826f6195, 0x6d5e34c2, 0xf9aa6b39, 0xef87c0d8, 0xfe02e038, 0x1b252984, 0x4d063aaf, 0x34f80855, 0x663dbdba, 0x81e78586, 0x6e0625e2, 0xbf4cc6f0, 0xe8dcfa71, 0x703b9c7d, 0x8180b304, 0x000099ff};
    uint32_t exp_len = 624;
    uint32_t M[20] = {0x70299bed, 0x101794c6, 0xc0151c1c, 0x6e64da6d, 0x264cf9a0, 0x402b2671, 0xaa98562e, 0x65a57f24, 0x6bfda86a, 0xb60080d7, 0x63b6d666, 0x503b34b3, 0x096ebf14, 0xabfb0940, 0x1d4ef5c0, 0x7961d0cc, 0x9ae404fe, 0x353bd35b, 0x3b5b7bb9, 0x0000c144};
    uint32_t M_prime[1] = {0xfd29061b};
    uint32_t R[20] = {0x629e8ac8, 0x43c746de, 0x09cc340f, 0x194c305a, 0x7a3926c6, 0xd80c8fac, 0x4798acb0, 0x511e86a8, 0xfa33516c, 0x4556a7cc, 0x88f1e35c, 0x13a98223, 0x76962fda, 0x73375581, 0xb12ad232, 0x1756220d, 0x88028d68, 0xc981e14d, 0x4a962524, 0x00008700};
    uint32_t R2[20] = {0x3d051fc3, 0x1ff9ffd7, 0x2acef04e, 0x809ff24d, 0xb2a4d767, 0x1c0e8ced, 0xba0c8d86, 0x9aa30e72, 0x79a14472, 0xa06cbe86, 0x8bdc9053, 0xf0bc376c, 0x74d95a1e, 0xe67f8054, 0x5a66bd37, 0x88988875, 0x348577ff, 0x96090655, 0x31eb9e93, 0x00005193};
    uint32_t expected_output[20] = {0xc683c8bf, 0xeca2c4d5, 0x2d9b69a4, 0xaeb71ed0, 0x7154ab0a, 0x294f7c2a, 0xd7bf6f30, 0xf19ddf5f, 0x98dff4e7, 0x0a564c64, 0x382cf5f2, 0xb4ba0bf5, 0xf634fe84, 0x35071fe9, 0x5e9d40e3, 0xa63d8e2e, 0xc552877d, 0xde671050, 0xff4c14aa, 0x00007d7b};
    uint32_t size =  20;
...
int test_datagram() {
    ...
    uint32_t counter = 0;
    uint32_t key[4] = {1,0};
    uint32_t to_send_buffer[4] = {0,1,2,3};
    int N_blocks_send = 1;
...
int test_reduce_cipher() {
    uint32_t ciphertext[40] = {0xe1745fd2, 0x244f532c, 0xcded56b8, 0xbdf5fb4e, 0x850f6ec7, 0x4d811d26, 0x7827748e, 0xfe08719a, 0x877de7ab, 0x30df79a4, 0x55d989d0, 0x45824754, 0xf8931386, 0xf2bd439b, 0x90600cb2, 0x8277acfa, 0x5264fec5, 0x8224b437, 0x22650c02, 0xeae1c4a5, 0xc6ed5a07, 0xfd5268a3, 0x62a1a0e9, 0x00948219, 0xcb5deb52, 0x15bdb981, 0x42195370, 0xe89bda34, 0xc5543062, 0x50b4a48d, 0x49ed2dd9, 0x56883c9e, 0x075b51a1, 0xc9bc05b0, 0x94e7c179, 0x6145f145, 0xa635fe9b, 0x841a6546, 0x827535fc, 0x00000000};
    uint32_t expected_Ct_p[20] = {0xe9ebcbc7, 0x9bd3d96b, 0x5dc58597, 0x942d6e6d, 0x99e645b2, 0x42d0b2dc, 0xbefbbdc1, 0x1482a5cb, 0xb925235e, 0xfda26f19, 0xc2388174, 0x2becf65d, 0xfde03fb3, 0x8b60ba97, 0x832f7f59, 0xac1e4dd5, 0xb395f755, 0x5e3c242c, 0x8f388e79, 0x0000bb1d};
    uint32_t expected_Ct_q[20] = {0x35f2473f, 0xe36c2ef1, 0x9755df7c, 0x6414242b, 0x587cfc80, 0xd5ebcdd2, 0x74a3153d, 0xd18ec4e6, 0x76e8cc61, 0xb126eb9b, 0x1504b084, 0x5ad846bd, 0x3ccd45b3, 0x8c280d0e, 0x43bc9756, 0x08ccb783, 0x6ec090ab, 0xd85cb4dc, 0x423179b8, 0x00003f67};

    uint32_t Ct_p[20];
    uint32_t Ct_q[20];
    printf("Testing reduce cipher\r\n");
    printf("Printing expected output:\r\n");
    printArray(expected_Ct_p, 20);
    printArray(expected_Ct_q, 20);

    reduce_cipher(Ct_p, Ct_q, ciphertext);
    printf("Printing output: \r\n");
    printArray(Ct_p, 20);
    printArray(Ct_q, 20);
    if (memcmp(Ct_p, expected_Ct_p, 20) != 0) {
        fprintf(stderr, "Wrong Ct_p!\r\n");
        abort();
    }
    if (memcmp(Ct_q, expected_Ct_q, 20) != 0) {
    fprintf(stderr, "Wrong Ct_q!\r\n");
    abort();
    }
    return 0;
}

int test_combine_crt_result() {
    uint32_t P_p[39] = {0xc683c8bf, 0xeca2c4d5, 0x2d9b69a4, 0xaeb71ed0, 0x7154ab0a, 0x294f7c2a, 0xd7bf6f30, 0xf19ddf5f, 0x98dff4e7, 0x0a564c64, 0x382cf5f2, 0xb4ba0bf5, 0xf634fe84, 0x35071fe9, 0x5e9d40e3, 0xa63d8e2e, 0xc552877d, 0xde671050, 0xff4c14aa, 0x00007d7b, 0};
    uint32_t P_q[39] = {0x84fa2bcb, 0x93a82a89, 0x2e357e2f, 0xcdd269e6, 0x24a66469, 0x840264ba, 0x8ebaef6e, 0x37c75d6c, 0xaa9983ab, 0x68c5b6ba, 0x0eb400dc, 0xcab99d73, 0x20b12bfc, 0xff62d140, 0x17132615, 0xa7001cd5, 0x83ae8696, 0xea61c950, 0xfa628512, 0x00001696, 0};
    uint32_t expected_output[39] = {0x53f9c740, 0x5a4572aa, 0xe3bc243f, 0x0a11ded0, 0x3c6773b5, 0x32f9bf68, 0xe5edac83, 0xe00d743e, 0x9de79141, 0x90b70941, 0x335c342b, 0xd8261b0f, 0x5d6b6996, 0x436c18b8, 0x2e4eda55, 0xcc75cafd, 0x790c12fd, 0x111fb213, 0x34ce70a9, 0xc3c26c09, 0x4315251c, 0xe2927779, 0xcbe8ef75, 0xec1eb181, 0x734a4d33, 0x91674d16, 0x7303e7e9, 0x2f6d5bce, 0xa993a9de, 0x595dc846, 0xfb5c677b, 0xa39b4443, 0x5fe4d421, 0x472621fc, 0x5cfa9f68, 0x4ec54058, 0x66c119ac, 0x0134fd0e, 0x0b457c8c};
    uint32_t output[39];

    printf("Testing combine CRT result\r\n");
    printf("Printing expected output:\r\n");
    printArray(expected_output, 39);

    combine_crt_result(output, P_p, P_q);

    printf("Printing combined output:\r\n");
    printArray(output, 39);

    if (memcmp(output, expected_output, 39) != 0) {
        fprintf(stderr, "Combining CRT result failed!\r\n");
        abort();
    }
    return 0;
}

int test_crt_rsa_sign() {
    uint32_t message[39] = {0xe1745fd2, 0x244f532c, 0xcded56b8, 0xbdf5fb4e, 0x850f6ec7, 0x4d811d26, 0x7827748e, 0xfe08719a, 0x877de7ab, 0x30df79a4, 0x55d989d0, 0x45824754, 0xf8931386, 0xf2bd439b, 0x90600cb2, 0x8277acfa, 0x5264fec5, 0x8224b437, 0x22650c02, 0xeae1c4a5, 0xc6ed5a07, 0xfd5268a3, 0x62a1a0e9, 0x00948219, 0xcb5deb52, 0x15bdb981, 0x42195370, 0xe89bda34, 0xc5543062, 0x50b4a48d, 0x49ed2dd9, 0x56883c9e, 0x075b51a1, 0xc9bc05b0, 0x94e7c179, 0x6145f145, 0xa635fe9b, 0x841a6546, 0x827535fc};
    uint32_t expected_output[39] = {0x53f9c740, 0x5a4572aa, 0xe3bc243f, 0x0a11ded0, 0x3c6773b5, 0x32f9bf68, 0xe5edac83, 0xe00d743e, 0x9de79141, 0x90b70941, 0x335c342b, 0xd8261b0f, 0x5d6b6996, 0x436c18b8, 0x2e4eda55, 0xcc75cafd, 0x790c12fd, 0x111fb213, 0x34ce70a9, 0xc3c26c09, 0x4315251c, 0xe2927779, 0xcbe8ef75, 0xec1eb181, 0x734a4d33, 0x91674d16, 0x7303e7e9, 0x2f6d5bce, 0xa993a9de, 0x595dc846, 0xfb5c677b, 0xa39b4443, 0x5fe4d421, 0x472621fc, 0x5cfa9f68, 0x4ec54058, 0x66c119ac, 0x0134fd0e, 0x0b457c8c};
    uint32_t output[39];

    printf("Testing CRT-RSA signing\r\n");
    printf("Printing expected output:\r\n");
    printArray(expected_output, 39);

    crt_rsa_sign(output, message);

    printf("Printing signed output:\r\n");
    printArray(output, 39);

    if (memcmp(output, expected_output, 39) != 0) {
        fprintf(stderr, "CRT-RSA signing failed\r\n");
        abort();
    }
    return 0;
}
